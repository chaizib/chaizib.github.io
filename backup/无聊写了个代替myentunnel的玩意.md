&emsp;&emsp;再也不能忍受myentunnel老是卡顿卡顿的，于是打算用AutoHotkey写个小玩意来代替。初步搞了一会，基本上myentunnel能做到的都能做到了，比如断线重连和隐藏plink.exe的黑窗口。至于如何实现账号密码记忆和保存，这个懒得写了，要写的话又得去看帮助文档…… 眼睛疼！
